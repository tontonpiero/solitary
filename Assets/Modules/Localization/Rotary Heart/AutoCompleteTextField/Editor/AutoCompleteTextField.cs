...
namespace RotaryHeart.Lib.AutoComplete
{
    public static class AutoCompleteTextField
    {
        ...
        public static class EditorGUILayout
        {
            ...
            {
                return AutoCompleteTextField("", text, GUI.skin.textField, entries, "", allowCustom, options);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
            ...
            {
                return AutoCompleteTextField("", text, GUI.skin.textField, entries, hint, allowCustom, options);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
            ...
            {
                return AutoCompleteTextField(label, text, GUI.skin.textField, entries, "", allowCustom, options);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
            ...
            {
                return AutoCompleteTextField(label, text, GUI.skin.textField, entries, hint, allowCustom, options);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
        ...
        public static class EditorGUI
        {
            ...
            {
                return AutoCompleteTextField(position, "", text, GUI.skin.textField, entries, "", allowCustom);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
            ...
            {
                return AutoCompleteTextField(position, "", text, GUI.skin.textField, entries, hint, allowCustom);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
            ...
            {
                return AutoCompleteTextField(position, label, text, GUI.skin.textField, entries, "", allowCustom);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
            ...
            {
                return AutoCompleteTextField(position, label, text, GUI.skin.textField, entries, hint, allowCustom);
            }
            /// <summary>
            /// Make a TextField that has an <paramref name="AutoCompleteWindow"/> logic for selecting options.
            /// </summary>
            ...
            public static string AutoCompleteTextField(Rect position, GUIContent label, string text, GUIStyle style, string[] entries, string hint, bool allowCustom = false)
            {
                ...
                return _AutoCompleteLogic(position, label, value, entries, hint, allowCustom);
            }
        }
        ...
        /// <param name="allowCustom">Should the system allow custom entries</param>
        /// <returns>Selected value from autocomplete window</returns>
        static string _AutoCompleteLogic(Rect position, GUIContent label, string text, string[] entries, string hint, bool allowCustom)
        {
            //Used to draw the window
            Rect lastRect = position;
            Vector2 myScreenPos = UnityEditor.EditorGUIUtility.GUIToScreenPoint(new Vector2(position.x, position.y));
